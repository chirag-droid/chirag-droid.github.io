...
export default function Home() {
  return (
    <section className='mb-[75px] mt-[80px] sm:mt-[125px]'>
      <svg id='home' className="z-[-1] w-[40%] top-[-40px] md:top-0 absolute right-0 sm:top-0 opacity-80 md:opacity-100" width="725" height="990" fill="none" xmlns="http://www.w3.org/2000/svg">
